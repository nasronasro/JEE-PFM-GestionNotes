...
<%@ include file="/common/Header.jsp" %>
	<form action="/Web003_tester/modify-professeur" method="post">
	<div class="form-row container d-flex flex-column align-items-center justify-content-center">
	  <div class="form-group col-md-6 mb-3">
	    <label class="form-label">ID</label>
	    <input type="text" name="id_professeur" class="form-control input-design" value="<%= request.getAttribute("id_prof").toString()%>" required>
